              ...
              <>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-red-300">Mode Layar Penuh</p>
                  </div>
                </Link>

                <Link
                  href="/tap-battle-monitor"
                  className="p-4 rounded-2xl bg-slate-900/90 border border-amber-500/40 hover:border-amber-400 flex items-center gap-3 transition-all hover:scale-105 shadow-glow"
                >
                  ...
                  <div>
                    <p className="text-xs font-bold text-white">Monitor Tap Battle</p>
                    <p className="text-[10px] text-indigo-300">Leaderboard Live</p>
                  </div>
                </Link>
