                ...
                {isAdminDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-52 glass-card-gold rounded-2xl p-2 border border-amber-400/50 shadow-2xl space-y-1 z-50">
                    ...
                    >
                      ...
                      <span>Kelola Polling Lapangan</span>
                    </Link>
                    <Link
                      href="/admin/cosplay"
                      onClick={() => setIsAdminDropdownOpen(false)}
                    ...
                    <Link
                      ...
                      onClick={() => setIsAdminDropdownOpen(false)}
                      className="flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold text-amber-300 hover:bg-merdeka-red/30 transition-colors"
                    >
                      <ShieldAlert className="w-4 h-4 text-amber-400" />
                      <span>Wasit Utama Cosplay</span>
                    </Link>
                    <Link
                      href="/stage-display"
                      onClick={() => setIsAdminDropdownOpen(false)}
